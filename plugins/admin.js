    ...
    if (Config.BANMSG == 'default') {
        if (message.reply_message !== false) {
            await message.client.sendMessage(
                ...
                MessageType.video, 
                { mimetype: Mimetype.gif, caption: "DevFelix Tarafından Banlandın!" }
            )
    ...
    if (Config.PROMOTEMSG == 'default') {
        if (message.reply_message !== false) {
            ...
            await message.client.sendMessage(
                ...
                MessageType.video, 
                { mimetype: Mimetype.gif, caption: "```DevFelix Tarafından Admin Yapıldın!```" }
            )
    ...
    if (Config.DEMOTEMSG == 'default') {
        if (message.reply_message !== false) {
            ...
            await message.client.sendMessage(
                ...
                MessageType.video, 
                { mimetype: Mimetype.gif, caption: "```DevFelix Tarafından Yetkin Düşürüldü!```" }
            )
