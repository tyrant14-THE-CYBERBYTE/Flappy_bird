...
Asena.addCommand({pattern: 'carbon ?(.*)', fromMe: true, desc: Lang.CARBON_DESC, warn: Lang.CARBON_WARN}, (async (message, match) => {
    ...
    if (match[1] === '' && !message.reply_message) {
        return await message.client.sendMessage(message.jid,Lang.CARBON_NEEDWORD, MessageType.text);
    }
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made for DevFelix'})
    }
